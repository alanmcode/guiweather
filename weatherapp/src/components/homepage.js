...
class Mainpage extends React.Component {
  ...
  async componentDidMount() {
    var { location } = this.context; // retrieves data from postcode page in location context

    // retrieves info from api, parses and then sets states with data from api
    ...
    // gets icon, and sets state to show high quality image from api using icon
    this.setState({
      weatherIcon:
    ...
    // perfect weather system - judges sport conditions based on temperature
    if (
    ...
    this.setState({ loading: false }); // when everything has finished loading, make false
